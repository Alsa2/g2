...
*Fig.3* **Flow diagram for the Bash program.**

### Main Program

![](Assets/MAIN_FD2.jpg)

*Fig.4* **Flow diagram for the main program.**
...
*Fig.6* **Complex Graph for Humidity**
...
*Fig.8* **Polyfit Graph for Humidity**
...
*Fig.10* **Error Bar Graph for Humidity**
